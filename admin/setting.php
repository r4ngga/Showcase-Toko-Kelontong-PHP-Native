            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col mb-4">
                            <a href="change_password.php" class="btn btn-info mb-2 mt-2">Change Password</a>
                            <div class="card" style="width: 18rem;">
                                <div class="card-body">
                                    <form action="setting_act.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group" hidden>
                                            <label for="id">Id</label>
                                            <input type="text" name="id" id="id" class="form-control" value="<?= $_SESSION['id'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="setting" id="update" value="Save Update" class="btn btn-primary mr-2">
